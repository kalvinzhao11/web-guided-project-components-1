...
// there is a shorter way to pull out open and close
...
function makePanel(panelDataObj/* what data does the panel need? */) {
  ...
  panelTitle.textContent = panelDataObj.title
  panelContent.textContent = panelDataObj.content
...
console.log(makePanel({ title: 'foo', content: 'bar' }))
